...
설치 또는 갱신 후에는 새 Codex 작업에서 플러그인을 사용하세요. marketplace 형식은 [Codex 플러그인 공식 문서](https://developers.openai.com/codex/plugins/build)를 참고할 수 있습니다.
...
chatgpt-work/                            # ChatGPT Work 마켓플레이스(samton-chatgpt) + 플러그인
